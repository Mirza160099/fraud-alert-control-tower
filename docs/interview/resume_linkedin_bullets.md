...
- Compared logistic regression, random forest, extra trees, gradient boosting, and AdaBoost models for imbalanced fraud detection; selected an AdaBoost champion based on F1 performance and queue discipline.
...
- AdaBoost champion model for fraud alert prioritization
