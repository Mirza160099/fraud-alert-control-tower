...
- Recruiter-friendly product thinking: the final app is not just a classifier; it is an investigator control tower with explanations, an investigator brief, and recommended next actions.
